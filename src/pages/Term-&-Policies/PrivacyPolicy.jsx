...
const PrivacyPolicy = () => {
  return (
    <>
      <Bannerv2 head="Privacy Policy" />
      <>
        {/* Privacy Fold Section Start Here */}
            ...
            <div className="row justify-content-center">
              <div className="col-12 col-sm-12 col-md-12 col-lg-10 col-xl-10 col-xxl-10">
                <div className="terms-content">
                  <h2>OVERVIEW</h2>
                  <p>
                    This website is operated by Penguin Author House. Throughout
                    the site, the terms “we”, “us” and “our” refer to Penguin
                    Author House. Penguin Author House offers this website,
                  ...
                  <p>
                    ...
                    current website shall also be subject to the Terms of
              ...
              <div className="col-12 col-sm-12 col-md-12 col-lg-10 col-xl-10 col-xxl-10">
                <div className="terms-content">
                  <h2>SECTION 1 - ONLINE WEBSITE TERMS</h2>
                  <p>
              ...
              <div className="col-12 col-sm-12 col-md-12 col-lg-10 col-xl-10 col-xxl-10">
                <div className="terms-content">
                  ...
                  <p>
                    ...
                    information. Any reliance on the material on this site is at
                    your own risk. This site may contain certain historical
                    information. Historical information, necessarily, is not
                    current and is provided for your reference only. We reserve
                    the right to modify the contents of this site at any time,
                    but we have no obligation to update any information on our
              ...
              <div className="col-12 col-sm-12 col-md-12 col-lg-10 col-xl-10 col-xxl-10">
                <div className="terms-content">
                  ...
                  <p>
                    ...
                    at any time. We shall not be liable to you or to any
              ...
              <div className="col-12 col-sm-12 col-md-12 col-lg-10 col-xl-10 col-xxl-10">
                <div className="terms-content">
                  ...
                  <p>
                    ...
                    at the website. We cannot guarantee that your computer
              ...
              <div className="col-12 col-sm-12 col-md-12 col-lg-10 col-xl-10 col-xxl-10">
                <div className="terms-content">
                  ...
                  <p>
                    ...
                    to notify you by contacting via e-mail and/or billing
              ...
              <div className="col-12 col-sm-12 col-md-12 col-lg-10 col-xl-10 col-xxl-10">
                <div className="terms-content">
                  ...
                  <p>
                    In no case shall Penguin Author House, our directors,
              ...
              <div className="col-12 col-sm-12 col-md-12 col-lg-10 col-xl-10 col-xxl-10">
                <div className="terms-content">
                  ...
                  <p>
                    You agree to indemnify, defend and hold harmless Penguin
                    Author House and our parent, subsidiaries, affiliates,
              ...
              <div className="col-12 col-sm-12 col-md-12 col-lg-10 col-xl-10 col-xxl-10">
                <div className="terms-content">
                  ...
                  <p>
                    ...
                    support@penguinauthorhouse.com.
                  </p>
                </div>
              </div>
            </div>
